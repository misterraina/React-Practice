            ...
            element={
              ...
              <div className='max-w-4xl w-full flex flex-col md:flex-row mx-auto space-y-6 md:space-y-0 md:space-x-6'>
                ...
                <div id='calculator' className="w-full md:w-1/2 p-4">
                  <h1 className="text-2xl mt-2 font-raleway font-bold mb-4 ">BMI Calculator</h1>
                  <InputForm setBmi={handleCalculate} />
                </div>

              {/* Make responsive use media queries if the containerResult is in horizontally flex when required vertically below the calculator */}

                <div ref={resultRef} id='gagueResult' className={`w-full mb:w-1/2 p-4 transition-all duration-500`}>
                <div className="text-center mb-4">

                  <h2 className='text-2xl font-bold font-raleway'>Result</h2>
                </div>
                  <div className="mx-auto flex justify-center items-center">
                    <GaugeChart value={bmi} />
                  </div>
                  <div className="text-center">
                    <h3 className="text-xl font-regular font-raleway">
